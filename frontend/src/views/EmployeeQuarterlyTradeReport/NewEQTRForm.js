...
const NewEQTRForm = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record, index) => {
        return <Input disabled={radioValue !== 3} onChange={onInputValueChange(index, 'stockTicker')} />
      },
    },
    {
      ...
      dataIndex: 'listedOn',
      render: (text, record, index) => {
        return <Input disabled={radioValue !== 3} onChange={onInputValueChange(index, 'listedOn')} />
      },
    },
    {
    ...
    },
    {
      ...
      render: () => {
        return (
          <Select disabled={radioValue !== 3} defaultValue='Long' onChange={onTypeChange}>
  ...
  return (
    <div
      ...
      <div>
        ...
        <span>
          As of the end of{' '}
          <Select defaultValue='Q1' style={{width: 120}} onChange={onQChange}>
          ...
          ,{' '}
          <Select defaultValue={currentYear} style={{width: 120}} onChange={onYearChange}>
